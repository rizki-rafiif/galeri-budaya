...
class TarianAdapter(context: FragmentManager):RecyclerView.Adapter<TarianAdapter.TarianViewHolder>(){
    var listBud = ArrayList<Budaya>()
    class TarianViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
