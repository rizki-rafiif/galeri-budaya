...
class DataBudaya(context: Context) {
    ...
    fun executeDB(){
        ...
        dbHelper.insertData("125","mendoan banyumas", "makanan", "jawa tengah"
            ...
            , ""
            , "")
        dbHelper.insertData("126","kebaya kerancang", "pakaian", "dki jakarta"
